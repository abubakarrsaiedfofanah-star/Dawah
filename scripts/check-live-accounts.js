...
async function main() {
  ...
  console.log(`Project: ${process.env.FIREBASE_PROJECT_ID || 'umma-university-da-awah-team'}`);
  console.log(`Checked at: ${new Date().toISOString()}`);
  printGroup('Firebase Auth users', authUsers, user => `${user.email || '(no email)'} | uid=${user.uid} | disabled=${user.disabled}`);
