...
function allowedOrigins(env) {
  const defaults = [
    ...
    'https://umma-university-da-awah-team.firebaseapp.com',
    'https://66ghz.com',
    'https://www.66ghz.com',
    'http://localhost:8000',
    'http://127.0.0.1:8000'
...
function isAllowedOrigin(origin, env) {
  ...
  try {
    ...
    return host === 'umma-university-da-awah-team.web.app'
      || host === 'umma-university-da-awah-team.firebaseapp.com'
      || host === '66ghz.com'
      || host === 'www.66ghz.com'
      || host === 'localhost'
      || host === '127.0.0.1';
...
async function answerQuestion(question, context, mode, env) {
  ...
  const websiteHelpNote = [
    "Website guidance: The UMMA University Da'awah Team website has public sections for Home, About Us, What We Do, Activities, Our Leadership, Gallery, Contact Us, and Open Portals.",
      ...
      messages: [
        {
          role: 'system',
          content: [
            "You are the UMMA University Da'awah Team advanced research assistant.",
