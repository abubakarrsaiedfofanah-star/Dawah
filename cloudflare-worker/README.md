# UMMA Dawah Groq AI Worker

This Cloudflare Worker handles Groq AI requests for the Supabase-hosted app without exposing the API key in frontend code.
...
```text
https://umma-dawah-groq-ai.<your-subdomain>.workers.dev
```
