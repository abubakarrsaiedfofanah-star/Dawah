...
test.describe('live Firebase feature audit', () => {
  ...
  test.afterAll(() => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify({
        ...
        baseUrl: liveBase,
        cleanupHint: 'Delete these pilot accounts from Firebase Authentication and matching Firestore member/role request documents after live audit runs.',
  ...
  test('student registration, login, finance modals, and chat widget shell', async ({ page }) => {
    ...
    await page.evaluate(data => {
      ...
      setValue('homeAddress', 'Pilot test address');
